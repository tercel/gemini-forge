---
description: "Port a project to a new target language — initializes project skeleton, analyzes reference, and batch-generates implementation plans"
argument-hint: "@docs-project --lang <language> [--ref <reference-impl>]"
