...
write_file to `<target-path>/.code-forge.json`:
...
Spawn an `generalist` sub-agent (`subagent_type: "general-purpose"`):
...
## Output Files
write_file ALL of the following files:
