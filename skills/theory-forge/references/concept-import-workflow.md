...
- `./cross-disciplinary-import-rules.md` — three-tier framework + CFLT-relevant import catalog
- `./academic-severity-levels.md` — severity rubric

**ON-DEMAND (load only at the listed step):**
- `./argument-patterns.md` — load at Step 4 ONLY for the §2.10 concept-smuggling fallacy cross-link
- `../templates/concept-import-audit.md` — load at Step 7 (Report Generation)
...
**Report structure**: read the template at `../templates/concept-import-audit.md` and fill in the `{placeholder}` values, including the Candidate-Import Lexicon Coverage table and the Cross-Doc Consistency Findings section. Loaded only at this step.
