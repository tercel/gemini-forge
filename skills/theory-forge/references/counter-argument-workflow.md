...
- `./argument-patterns.md` — §1 Rebuttal element of Toulmin
- `./academic-severity-levels.md` — severity rubric

**ON-DEMAND (load only at the listed step):**
- `./falsifiability-template.md` — load at Step 1 ONLY for Type A/E classification of central claims (skip B/C/D)
- `../templates/counter-argument-audit.md` — load at Step 6 (Report Generation)
...
**Report structure**: read the template at `../templates/counter-argument-audit.md` and fill in the `{placeholder}` values, including the Engagement Profile table and the Strawman Engagement section. Loaded only at this step.
