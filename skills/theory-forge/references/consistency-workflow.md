...
- `./falsifiability-template.md` — load at Step 4.5 ONLY for Type E recognition (hypothesis-vs-refinement check)
- `./argument-patterns.md` — load at Step 5 ONLY when scanning for equivocation cross-references
- `../templates/consistency-report.md` — load at Step 6 (Report Generation)
...
**Report structure**: read the template at `../templates/consistency-report.md` and fill in the `{placeholder}` values. Preserve heading hierarchy and severity ordering. The template is loaded only at this step.
