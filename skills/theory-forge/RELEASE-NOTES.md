...
- `/theory-forge:concept-import` — Cross-disciplinary borrowing tier marking. Three-tier framework (T1 technical equivalence / T2 partial equivalence with explicit limits / T3 metaphorical analogy). Catches concept smuggling. Brigandt & Love (2017); Wimsatt (2007).
...
- `skills/shared/cross-disciplinary-import-rules.md` — three-tier framework + CFLT-relevant import catalog
