...
Read the scope workflow definition at:
`../references/scope-workflow.md`

Also read:
- `../references/argument-patterns.md` — §1 Qualifier element of Toulmin (cross-reference)
- `../references/falsifiability-template.md` — Type A/B/C/D/E (used for gating)
