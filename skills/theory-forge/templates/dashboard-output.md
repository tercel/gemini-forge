...
Render this per-command template, sourcing the values from `commands/{command}.md` (description, argument-hint, Usage Examples block) and `references/{command}-workflow.md` (Anti-patterns, severity rules):
